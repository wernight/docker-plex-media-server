...
================================================
  ...
  * [`1.1`, `1.1.4`, `1.1.4.2757`](https://github.com/wernight/docker-plex-media-server/blob/v1.1.4.2757/Dockerfile) (or similar) are like `latest` but for a specific version
